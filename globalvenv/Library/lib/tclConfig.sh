...
# installed.
TCL_PREFIX='E:/Coding_23CSB0B30/ML, DL, NLP with Python/globalvenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/Coding_23CSB0B30/ML, DL, NLP with Python/globalvenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/Coding_23CSB0B30/ML, DL, NLP with Python/globalvenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/Coding_23CSB0B30/ML, DL, NLP with Python/globalvenv\Library\include'
...
TCL_PACKAGE_PATH='E:/Coding_23CSB0B30/ML, DL, NLP with Python/globalvenv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/Coding_23CSB0B30/ML, DL, NLP with Python/globalvenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/Coding_23CSB0B30/ML, DL, NLP with Python/globalvenv\Library\lib\tclstub86.lib'
